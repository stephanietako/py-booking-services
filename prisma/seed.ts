...
async function main() {
  ...
  await prisma.pricingRule.deleteMany({
    where: {
      service: { name: "Évasion en mer – Cap Camarat 12.5" },
    },
  });
...
//   // Supprimer les règles tarifaires du service "Test Service"
//   await prisma.pricingRule.deleteMany({
//     where: {
...
//   // Puis supprimer le service "Test Service"
//   await prisma.service.deleteMany({
//     where: { name: "Test Service" },
//   });

//   // ✅ Upsert service principal
//   await prisma.service.upsert({
//     where: { name: "Évasion en mer – Cap Camarat 12.5" },
//     update: {
//       description:
...
//   // --- AJOUT : Upsert du service "Test Service" ---
//   await prisma.service.upsert({
//     where: { name: "Test Service" },
//     update: {},
//     create: {
//       name: "Test Service",
//       description: "Service pour test en production, tarif symbolique de 1€",
//       defaultPrice: 1,
//       isFixed: true,
//       amount: 1,
//       price: 1,
...
//   // --- Récupération du service test pour insérer ses règles tarifaires ---
//   const service = await prisma.service.findUnique({
//     where: { name: "Évasion en mer – Cap Camarat 12.5" },
//   });
//   if (!service) throw new Error("❌ Service principal introuvable");

//   const testService = await prisma.service.findUnique({
//     where: { name: "Test Service" },
//   });
//   if (!testService) throw new Error("❌ Test Service introuvable");

//   // ✅ Insertion des règles de tarification dynamiques (2025-2030) pour service principal
//   const startYear = 2025;
//   const endYear = 2030;
...
//   // ✅ Insertion règle tarifaire fixe 1€ pour le service test (2025-2030)
//   const testPricingRules = [];
//   for (let year = startYear; year <= endYear; year++) {
//     testPricingRules.push({
