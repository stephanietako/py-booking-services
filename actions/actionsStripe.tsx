...
//   bookingId: number,
//   domainUrl: string,
//   stripeCustomerId: string // ✅ Nouveau paramètre
// ): Promise<string> {
//   try {
...
//     // Dans votre fonction createStripeCheckoutSession, ajoutez ceci :
//     const session = await stripe.checkout.sessions.create({
//       customer: stripeCustomerId,
//       payment_method_types: ["card"],
//       line_items: lineItems,
//       mode: "payment",
//       success_url: `${domainUrl}/users/payment/success?session_id={CHECKOUT_SESSION_ID}&booking_id=${bookingId}`,
//       cancel_url: `${domainUrl}/booking/cancel?booking_id=${bookingId}`,
//       metadata: {
//         bookingId: bookingId.toString(),
//         customerId: stripeCustomerId,
//       },
//       // ✅ AJOUTEZ CECI : Transférer les métadonnées au Payment Intent
//       payment_intent_data: {
//         metadata: {
//           bookingId: bookingId.toString(),
//           customerId: stripeCustomerId,
