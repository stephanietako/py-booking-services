// // ServiceListTestReservation.tsx
// "use client";
...
//           // For test : price fixed to 1 regardless of dates
//           setBaseServicePrice(1);
...
//           // ** On conserve toutes les options, y compris celles à 0 euro **
...
//   // Here withCaptainForced is true, so captain option price is ignored
...
//                                 )
//                               }
//                               // On bloque la modification si prix = 0
//                               disabled={option.unitPrice === 0}
//                             />
//                           </div>
//                         )}
//                       </div>
...
//                   {/* For test, captain forced to "J'ai mon propre capitaine" */}
//                   <p style={{ marginTop: "1rem", fontWeight: "bold" }}>
...
//   // Dans votre useEffect qui récupère les options, modifiez cette partie :
...
//           // MODIFICATION : Forcer toutes les options à 0€ pour le test
...
//   // Et aussi modifier la fonction handleOptionQuantityChange pour s'assurer que le prix reste à 0 :
