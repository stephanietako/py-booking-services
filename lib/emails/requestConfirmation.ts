...
export function requestConfirmationEmail(
  ...
  // Formatage des dates avec contexte pour le debugging
  const formattedStart = format(
    safeDate(params.startTime, "startTime"),
    "dd/MM/yyyy 'de' HH:mm"
  );
  const formattedEnd = format(safeDate(params.endTime, "endTime"), "HH:mm");
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
      ...
      <ul style="list-style-type: none; padding: 0;">
        ...
        <li><strong>Date et heure :</strong> Le ${formattedStart} / ${formattedEnd}</li>
